...
public class SData_kejitree_gongji_data : MonoEX.Singleton<SData_kejitree_gongji_data>
{
    public void setData(LuaTable table1, LuaTable table2)
    {
        ...
        {
            kejitree_gongji_dataInfo dif = new kejitree_gongji_dataInfo();
    ...
    public kejitree_gongji_dataInfo GetDataOfID(int Id)
    {
        if (!Data.ContainsKey(Id)) throw new Exception(String.Format("kejitree_gongji_dataInfo::GetDataOfID() not found data  Id:{0}", Id));
        return Data[Id];
    }

    internal Dictionary<int, kejitree_gongji_dataInfo> Data = new Dictionary<int, kejitree_gongji_dataInfo>();
}


public struct kejitree_gongji_dataInfo
{
	 /// <summary>
	 ///
	 /// </summary>
