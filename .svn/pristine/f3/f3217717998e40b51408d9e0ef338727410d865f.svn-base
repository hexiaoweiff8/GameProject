...
public class Packager
{
    ...
    private static void HandleLuaBundle()
    {
        ...
        string srcDir2 = Application.dataPath + "/QKLibs/Asset_ulua/ToLua/Lua/";
    ...
    [MenuItem("打包游戏资源/Build Protobuf-lua-gen File")]
    public static void BuildProtobufFile()
    {
        string dir = AppDataPath + "/Lua/proto";
        mPaths.Clear(); mFiles.Clear(); Recursive(dir);

        string protoc = "\"" + AppDataPath + "/../PBCreater/protoc-gen-lua-master/protoc.exe" + "\"";
        string protoc_gen_dir = "\"" + AppDataPath + "/../PBCreater/protoc-gen-lua-master/plugin/protoc-gen-lua.bat" + "\"";
        ...
        foreach (string f in mFiles)
        {
            ...
            info.Arguments = "--plugin=protoc-gen-lua=" + protoc_gen_dir + " --lua_out=. " + name;
            info.WindowStyle = ProcessWindowStyle.Hidden;
