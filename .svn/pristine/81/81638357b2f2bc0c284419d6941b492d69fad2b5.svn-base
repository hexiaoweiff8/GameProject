...
public class SData_kejitree_shengming_data : MonoEX.Singleton<SData_kejitree_shengming_data>
{
    public void setData(LuaTable table1, LuaTable table2)
    {
        ...
        {
            kejitree_shengming_dataInfo dif = new kejitree_shengming_dataInfo();
    ...
    public kejitree_shengming_dataInfo GetDataOfID(int Id)
    {
        if (!Data.ContainsKey(Id)) throw new Exception(String.Format("kejitree_shengming_dataInfo::GetDataOfID() not found data  Id:{0}", Id));
        return Data[Id];
    }

    internal Dictionary<int, kejitree_shengming_dataInfo> Data = new Dictionary<int, kejitree_shengming_dataInfo>();
}


public struct kejitree_shengming_dataInfo
{
	 /// <summary>
	 ///
	 /// </summary>
