...
[CustomEditor(typeof(QKUIButton), true)]
public class QKUIButtonEditor : UIButtonColorEditor
{
    enum Highlight
    {
        DoNothing,
    ...
    protected override void DrawProperties()
    {
        ...
        QKUIButton btn = target as QKUIButton;
            ...
            if (sprite != null)
            {
                if (NGUIEditorTools.DrawHeader("Sprites", "Sprites", false, true))
                {
                    ...
                    EditorGUI.BeginDisabledGroup(serializedObject.isEditingMultipleObjects);
                    {
                        ...
                        NGUIEditorTools.DrawSpriteField("Normal", serializedObject, atlas, serializedObject.FindProperty("normalSpriteSprite"), true);
            ...
            else if (s2d != null)
            {
                if (NGUIEditorTools.DrawHeader("Sprites", "Sprites", false, true))
                {
                    ...
                    EditorGUI.BeginDisabledGroup(serializedObject.isEditingMultipleObjects);
                    {
                        ...
                        NGUIEditorTools.DrawProperty("Normal", serializedObject, "normalSpriteSprite2D");
                        obj.ApplyModifiedProperties(); 
