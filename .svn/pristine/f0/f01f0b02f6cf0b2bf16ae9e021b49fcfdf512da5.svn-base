...
public class UIDragObjectEX : MonoBehaviour
{
    ...
    public DragEffect dragEffect = DragEffect.None;

    /// <summary>
    /// How much momentum gets applied when the press is released after dragging.
    /// </summary>

    public float momentumAmount = 0;
    ...
    void OnEnable()
    {
        ...
        mLastTargetPos = (target != null) ? target.localPosition : Vector3.zero;
    }
    ...
    void OnPress(bool pressed)
    {
        ...
        if (enabled && NGUITools.GetActive(gameObject) && target != null)
        {
            ...
            else if (mPressed && mTouchID == UICamera.currentTouchID)
            {
                ...
                //回到拖动起始点
                //SpringPosition sp = SpringPosition.Begin(target.gameObject, mLastTargetPos, 13f);
                //sp.ignoreTimeScale = true;
                //sp.worldSpace = false;
                //sp.onFinished = () => { func.Call(); };
            }
        }
    }
