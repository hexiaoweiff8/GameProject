...
class MapGridRender : MonoBehaviour
{
    ...
    void OnPostRender()
    {
        ...
        float hx = DiamondGridMap.harf_wxs * SData_MapData.Single.TerrainCellBianchang - 0.05f;
        float hy = SData_MapData.Single.TerrainCellBianchang - 0.05f;
        float harfC = SData_MapData.Single.TerrainCellBianchang / 2 - 0.05f;

        var p1 = new Vector3(-hx, 0.1f, -harfC);
        var p2 = new Vector3(0, 0.1f, -SData_MapData.Single.TerrainCellBianchang);
        var p3 = new Vector3(hx, 0.1f, -harfC);
        var p4 = new Vector3(hx, 0.1f, harfC);
        var p5 = new Vector3(0, 0.1f, SData_MapData.Single.TerrainCellBianchang);
