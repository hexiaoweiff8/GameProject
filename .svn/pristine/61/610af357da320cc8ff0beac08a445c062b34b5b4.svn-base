...
function GetStreamProgressForLevel() end 
...
function CanStreamedLevelBeLoaded() end 
...
function OverlapSphereNonAlloc() end 
...
function OverlapCapsuleNonAlloc() end 
...
function CapsuleCastNonAlloc() end 
...
function SphereCastNonAlloc() end 
...
function OverlapBoxNonAlloc() end 
...
function IgnoreLayerCollision() end 

----Boolean Physics.GetIgnoreLayerCollision(Int32 layer1,Int32 layer2)
function GetIgnoreLayerCollision() end 
...
function SetGlobalAnisotropicFilteringLimits() end 
...
function CreateExternalTexture() end 
...
function SetGlobalFloatArray() end 
...
function SetGlobalVectorArray() end 
...
function LoadFromCacheOrDownload() end 
...
function LoadFromFileAsync() end 
...
function ClearParticles() end 

----Void ParticleEmitter:Emit()
--Void ParticleEmitter:Emit(Int32 count)
--Void ParticleEmitter:Emit(Vector3 pos,Vector3 velocity,Single size,Single energy,Color color)
--Void ParticleEmitter:Emit(Vector3 pos,Vector3 velocity,Single size,Single energy,Color color,Single rotation,Single angularVelocity)
function Emit() end 

----Void ParticleEmitter:Simulate(Single deltaTime)
function Simulate() end 
...
function GetTemporary() end 

----Void RenderTexture.ReleaseTemporary(RenderTexture temp)
function ReleaseTemporary() end 
...
function GetTextAnchorPivot() end 
...
function NormalizedToPoint() end 

----Vector2 Rect.PointToNormalized(Rect rectangle,Vector2 point)
function PointToNormalized() end 
...
function add_reapplyDrivenProperties() end 

----Void RectTransform.remove_reapplyDrivenProperties(ReapplyDrivenProperties value)
function remove_reapplyDrivenProperties() end 
...
function RectangleContainsScreenPoint() end 
...
function ScreenPointToWorldPointInRectangle() end 
...
function ScreenPointToLocalPointInRectangle() end 
...
function add_willRenderCanvases() end 

----Void Canvas.remove_willRenderCanvases(WillRenderCanvases value)
function remove_willRenderCanvases() end 

----Material Canvas.GetDefaultCanvasMaterial()
function GetDefaultCanvasMaterial() end 

----Material Canvas.GetETC1SupportedCanvasMaterial()
function GetETC1SupportedCanvasMaterial() end 

----Void Canvas.ForceUpdateCanvases()
function ForceUpdateCanvases() end 
...
--*
--[Comment]
--consturctor for GameResFactory overrides:
--*
--GameResFactory.New()
--*

function GameResFactory.New() end
--*
----GameResFactory GameResFactory.Instance()
function Instance() end 

----Texture2D GameResFactory:GetGoFromPrefab(String spName)
function GetGoFromPrefab() end 

----Void GameResFactory:GetUIPrefab(String assetName,GameObject parent,LuaTable luaTable,LuaFunction luaCallBack)
function GetUIPrefab() end 

----Void GameResFactory:DestroyUIPrefab(GameObject go)
function DestroyUIPrefab() end 

----Void GameResFactory:GetUIEffect(String effname,LuaFunction luaCallBack)
function GetUIEffect() end 

----Void GameResFactory:DestroyUIEffect(GameObject obj)
function DestroyUIEffect() end 

----Void GameResFactory:DestroyAllUIEffect()
function DestroyAllUIEffect() end 
...
----Void NetworkManager:OnSocketData(Int32 key,ByteBuffer value)
...
----Void NetworkManager.AddEvent(Int32 _event,ByteBuffer data)
function AddEvent() end 
...
function CalculateRaycastDepth() end 
...
function NormalizeWidgetDepths() end 

----Void NGUITools.NormalizePanelDepths()
function NormalizePanelDepths() end 
...
function DestroyChildren() end 

----Void NGUITools.DestroyImmediate(Object obj)
function DestroyImmediate() end 
...
function ApplyPMA() end 

----Void NGUITools.MarkParentAsChanged(GameObject go)
function MarkParentAsChanged() end 
...
function IsPressed() end 

----Int32 UICamera.CountInputSources()
function CountInputSources() end 
...
function CancelNextTooltip() end 

----Boolean UICamera.ShowTooltip(GameObject go)
function ShowTooltip() end 

----Boolean UICamera.HideTooltip()
function HideTooltip() end 
...
--Void WndManage:DestroyWnd(String wndName,Single duration,Action`1 reCall)
function DestroyWnd() end 

----Void WndManage:RegWnd(String wndName,String dependPackets,Int32 sort,Int32 cacheTime,WndFadeMode fade,WndAnimationMode animaMode)
function RegWnd() end 

----Void WndManage:RegWnd1(String wndName,String dependPackets,Int32 sort,Int32 cacheTime,Int32 fade,Int32 animaMode)
function RegWnd1() end 

----HashSet`1 WndManage:GetDependPackets(List`1 wndNames)
function GetDependPackets() end 

----Void WndManage:ShowWnd(String wndName,Single duration,Boolean isWithBg,Action`1 reCall)
function ShowWnd() end 

----Void WndManage:HideWnd(String wndName,Single duration,Action`1 reCall)
function HideWnd() end 

----Void WndManage:PreLoadDepend(String wndName,Action`1 reCall)
...
function LoadMainBaseActors() end 
...
--*
--[Comment]
-- property: Boolean Wnd.IsNewInstance	get	
IsNewInstance = nil 
--*
--[Comment]
...
IsVisible = nil 
--*
----Void Wnd:Hide(Single duration,WShowType wt)
function Hide() end 
...
--*
--[Comment]
--consturctor for myTest overrides:
--*
--myTest.New()
--*

function myTest.New() end
--*
--[Comment]
-- property: Boolean myTest.useGUILayout	get	set	
useGUILayout = nil 
--*
--[Comment]
-- property: Boolean myTest.enabled	get	set	
enabled = nil 
--*
--[Comment]
-- property: Boolean myTest.isActiveAndEnabled	get	
isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform myTest.transform	get	
transform = nil 
--*
--[Comment]
-- property: GameObject myTest.gameObject	get	
gameObject = nil 
--*
--[Comment]
-- property: String myTest.tag	get	set	
tag = nil 
--*
--[Comment]
-- property: String myTest.name	get	set	
name = nil 
--*
--[Comment]
-- property: HideFlags myTest.hideFlags	get	set	
hideFlags = nil 
--*
wndShowHideInfo = {} 
--*
...
----Void AstarFight:setTempList3(Int32[] a,Int32 index)
function setTempList3() end 

----Void AstarFight:setZhenxingMaxX(Int32 a,Int32 index)
function setZhenxingMaxX() end 

----Vector3 AstarFight:getNum(Vector3 p)
function getNum() end 

----Void AstarFight:toXunLu(Boolean isEnemy,Int32 groupIndex)
function toXunLu() end 
...
--*
--[Comment]
--consturctor for SchoolManager overrides:
--*
--SchoolManager.New()
--*

function SchoolManager.New() end
--*
--[Comment]
-- property: Boolean SchoolManager.useGUILayout	get	set	
useGUILayout = nil 
--*
--[Comment]
-- property: Boolean SchoolManager.enabled	get	set	
enabled = nil 
--*
--[Comment]
-- property: Boolean SchoolManager.isActiveAndEnabled	get	
isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform SchoolManager.transform	get	
transform = nil 
--*
--[Comment]
-- property: GameObject SchoolManager.gameObject	get	
gameObject = nil 
--*
--[Comment]
-- property: String SchoolManager.tag	get	set	
tag = nil 
--*
--[Comment]
-- property: String SchoolManager.name	get	set	
name = nil 
--*
--[Comment]
-- property: HideFlags SchoolManager.hideFlags	get	set	
hideFlags = nil 
--*
----Void SchoolManager:Start()
function Start() end 

----Void SchoolManager:Update()
function Update() end 

----Void SchoolManager.ClearAllGroup()
function ClearAllGroup() end 

----SchoolGroup SchoolManager.GetGroupById(Int32 groupId)
...
----Void LGYLOG.LogError(String logError)
function LogError() end 

----Void LGYLOG.LogWarning(String logWarning)
function LogWarning() end 
...
--*
--CreateActorParam.New(AvatarCM cmType,Boolean colorMat,Int32 flagColorIdx,String meshPackName,String texturePackName,Boolean isHero)
--*
