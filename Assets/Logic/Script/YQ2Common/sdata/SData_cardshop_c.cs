...
public class SData_cardshop_c : MonoEX.Singleton<SData_cardshop_c>
{
    ...
    public cardshop_cInfo GetDataOfID(int Id)
    {
        if (!Data.ContainsKey(Id)) throw new Exception(String.Format("cardshop_cInfo::GetDataOfID() not found data  Id:{0}", Id));
        return Data[Id];
    }

    internal Dictionary<int, cardshop_cInfo> Data = new Dictionary<int, cardshop_cInfo>();
}


public struct cardshop_cInfo
{
	 /// <summary>
	 ///商店ID
	 /// </summary>
