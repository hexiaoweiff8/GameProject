...
public class SData_dailymission_c : MonoEX.Singleton<SData_dailymission_c>
{
    public void setData(LuaTable table1, LuaTable table2)
    {
        ...
        {
            dailymission_cInfo dif = new dailymission_cInfo();
            SDataUtils.dealTable((LuaTable)o2, (Object o11, Object o22) =>
            {
                switch (head[(int)(double)o11 - 1])
				{
					case "ID": dif.ID = (short)(double)o22; break;
					case "MissionType": dif.MissionType = (string)o22; break;
					case "TypeID": dif.TypeID = (short)(double)o22; break;
					case "ChildID": dif.ChildID = (short)(double)o22; break;
    ...
    public dailymission_cInfo GetDataOfID(int Id)
    {
        if (!Data.ContainsKey(Id)) throw new Exception(String.Format("dailymission_cInfo::GetDataOfID() not found data  Id:{0}", Id));
        return Data[Id];
    }

    internal Dictionary<int, dailymission_cInfo> Data = new Dictionary<int, dailymission_cInfo>();
}


public struct dailymission_cInfo
{
	 /// <summary>
	 ///唯一
	 /// </summary>
