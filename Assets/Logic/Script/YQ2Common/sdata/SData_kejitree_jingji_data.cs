...
public class SData_kejitree_jingji_data : MonoEX.Singleton<SData_kejitree_jingji_data>
{
    public void setData(LuaTable table1, LuaTable table2)
    {
        ...
        {
            kejitree_jingji_dataInfo dif = new kejitree_jingji_dataInfo();
    ...
    public kejitree_jingji_dataInfo GetDataOfID(int Id)
    {
        if (!Data.ContainsKey(Id)) throw new Exception(String.Format("kejitree_jingji_dataInfo::GetDataOfID() not found data  Id:{0}", Id));
        return Data[Id];
    }

    internal Dictionary<int, kejitree_jingji_dataInfo> Data = new Dictionary<int, kejitree_jingji_dataInfo>();
}


public struct kejitree_jingji_dataInfo
{
	 /// <summary>
	 ///
	 /// </summary>
