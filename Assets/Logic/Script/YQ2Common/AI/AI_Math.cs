...
public class AI_Math
{
    ...
    {
        var re = flag == ArmyFlag.Attacker ? x : (SData_MapData.Single.MapMaxColumn - x + (z%2==0?1:2));
    ...
    {
        float fGDis = objWorldDistance / SData_MapData.Single.TerrainCellBianchang / DiamondGridMap.wxs;//浮点格子距离
    ...
    { 
        ...
        float fGDis =    worldDistance/SData_MapData.Single.TerrainCellBianchang/DiamondGridMap.wxs;//浮点格子距离
