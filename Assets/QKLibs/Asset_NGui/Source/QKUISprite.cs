...
[ExecuteInEditMode]
[AddComponentMenu("QK/UI/QKUISprite")]
public class QKUISprite : UIBasicSprite
{
    ...
    public override Material material { get {
        if (mAtlas != null&&UseManualMaterial && _Material != null) { _Material.mainTexture = mAtlas.spriteMaterial.mainTexture; return _Material; }
    ...
    public bool UseManualMaterial
    {
        get { return _UseManualMaterial; }
        set
        {
            _UseManualMaterial = value;
            //MarkAsChanged(); 
            RemoveFromPanel();
            CreatePanel();
        }
