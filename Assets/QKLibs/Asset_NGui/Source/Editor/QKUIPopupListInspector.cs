...
/// <summary>
/// Inspector class used to edit QKUIPopupLists.
/// </summary>

[CustomEditor(typeof(QKUIPopupList))]
public class QKUIPopupListInspector : UIWidgetContainerEditor
{
	enum FontType
	{
		Bitmap,
