local data ={
	...
	body={
		[101]={101,"指挥官",1,1,"-1",1,"ui_equip","","zhujiemian_tubiao_zhihuiguan"},
		[102]={102,"部队",1,1,"-1",1,"ui_zhanshu","require('uiscripts/cardyc/redDotControl'):mainCall()","zhujiemian_tubiao_budui"},
		...
		[108]={108,"抽奖",1,5,"-1",-1,"","",""},
		[109]={109,"科技",1,5,"-1",1,"","",""},
		[110]={110,"任务",1,5,"-1",1,"ui_dailyMission","require('uiscripts/dailyMission/dailyMission_model'):GetCanRecevieNum()",""},
