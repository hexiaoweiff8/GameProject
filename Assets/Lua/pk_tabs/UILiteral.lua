local data = {
    ...
    body = {
        ...
        [0xFFF9] = {0xFFF9,"货币不足，无法分解"},
        [0xFFF8] = {0xFFF8,"所选装备已分解."},
        [0xFFF7] = {0xFFF7,"还没有选中任何要分解的装备"},
        [0xFFF6] = {0xFFF6,"碎片剩余："},
        [0xFFF5] = {0xFFF5,"装备已解锁"},
        [0xFFF4] = {0xFFF4,"装备已锁定"},
        [0xFFF3] = {0xFFF3,"存在相同部位装备,将卸下之前装备"},
        [0xFFF2] = {0xFFF2,"能量点不足"},
        [0xFFF1] = {0xFFF1,"已强化到+"},
        [0xFFF0] = {0xFFF0,"该装备无法重铸"},
        ...
        [0xFD03] = {0xFD03,"倒计时结束，刷新商店"},
        [0xFD04] = {0xFD04,"刷新卡不足"},
        [0xFD05] = {0xFD05,"商品已购买"},
        [0xFD06] = {0xFD06,"不足"},
        [0xFD07] = {0xFD07,"该商品已售出"},
        --tips界面字符串
        [0xFC01] = {0xFC01,"主属性从：%s中随机"},
        --卡牌商店界面字符串
        [0xFB01] = {0xFB01,"点数不足,无法购买"},
        [0xFB02] = {0xFB02,"卡牌未激活,无法购买"},
        ...
        [50006] = {50006,"智械"},
        [50007] = {50007,"未激活"},
        [50008] = {50008,"说明：可以退役多余的兵种卡牌来换取兵牌，退役不会影响卡牌的培养进度"},
        [50009] = {50009,"退役以上卡牌可以获得："},
        [500010] = {500010,"确认退役"},
        [500011] = {500011,"地面单位"},
        [500012] = {500012,"空中单位"},
        [500013] = {500013,"建筑单位"},
