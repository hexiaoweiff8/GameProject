...
local BATTLEROLE_BATTLE_FIELD = protobuf.FieldDescriptor();
...
GETPVPCONTI = protobuf.Descriptor();
local GETPVPCONTI_BATTLE_FIELD = protobuf.FieldDescriptor();
local GETPVPCONTI_CARD_FIELD = protobuf.FieldDescriptor();
local GETPVPCONTI_EQUIP_FIELD = protobuf.FieldDescriptor();
local GETPVPCONTI_CURRENCY_FIELD = protobuf.FieldDescriptor();
local GETPVPCONTI_ITEM_FIELD = protobuf.FieldDescriptor();
GETPVPTOTAL = protobuf.Descriptor();
local GETPVPTOTAL_BATTLE_FIELD = protobuf.FieldDescriptor();
local GETPVPTOTAL_CARD_FIELD = protobuf.FieldDescriptor();
local GETPVPTOTAL_EQUIP_FIELD = protobuf.FieldDescriptor();
local GETPVPTOTAL_CURRENCY_FIELD = protobuf.FieldDescriptor();
local GETPVPTOTAL_ITEM_FIELD = protobuf.FieldDescriptor();
EXITPVP = protobuf.Descriptor();
local EXITPVP_BATTLE_FIELD = protobuf.FieldDescriptor();
...
BATTLEROLE_BATTLE_FIELD.name = "battle"
BATTLEROLE_BATTLE_FIELD.full_name = ".BattleRole.battle"
BATTLEROLE_BATTLE_FIELD.number = 5
BATTLEROLE_BATTLE_FIELD.index = 4
BATTLEROLE_BATTLE_FIELD.label = 2
BATTLEROLE_BATTLE_FIELD.has_default_value = false
BATTLEROLE_BATTLE_FIELD.default_value = nil
BATTLEROLE_BATTLE_FIELD.message_type = role_pb.BATTLE
BATTLEROLE_BATTLE_FIELD.type = 11
BATTLEROLE_BATTLE_FIELD.cpp_type = 10

BATTLEROLE.name = "BattleRole"
BATTLEROLE.full_name = ".BattleRole"
BATTLEROLE.nested_types = {}
BATTLEROLE.enum_types = {}
BATTLEROLE.fields = {BATTLEROLE_LV_FIELD, BATTLEROLE_CARD_FIELD, BATTLEROLE_EQUIP_FIELD, BATTLEROLE_SCI_FIELD, BATTLEROLE_BATTLE_FIELD}
...
GETPVPCONTI_BATTLE_FIELD.name = "battle"
GETPVPCONTI_BATTLE_FIELD.full_name = ".GetPvpConti.battle"
GETPVPCONTI_BATTLE_FIELD.number = 1
GETPVPCONTI_BATTLE_FIELD.index = 0
GETPVPCONTI_BATTLE_FIELD.label = 2
GETPVPCONTI_BATTLE_FIELD.has_default_value = false
GETPVPCONTI_BATTLE_FIELD.default_value = nil
GETPVPCONTI_BATTLE_FIELD.message_type = role_pb.BATTLE
GETPVPCONTI_BATTLE_FIELD.type = 11
GETPVPCONTI_BATTLE_FIELD.cpp_type = 10

GETPVPCONTI_CARD_FIELD.name = "card"
GETPVPCONTI_CARD_FIELD.full_name = ".GetPvpConti.card"
GETPVPCONTI_CARD_FIELD.number = 2
GETPVPCONTI_CARD_FIELD.index = 1
GETPVPCONTI_CARD_FIELD.label = 3
GETPVPCONTI_CARD_FIELD.has_default_value = false
GETPVPCONTI_CARD_FIELD.default_value = {}
GETPVPCONTI_CARD_FIELD.message_type = role_pb.CARD
GETPVPCONTI_CARD_FIELD.type = 11
GETPVPCONTI_CARD_FIELD.cpp_type = 10

GETPVPCONTI_EQUIP_FIELD.name = "equip"
GETPVPCONTI_EQUIP_FIELD.full_name = ".GetPvpConti.equip"
GETPVPCONTI_EQUIP_FIELD.number = 3
GETPVPCONTI_EQUIP_FIELD.index = 2
GETPVPCONTI_EQUIP_FIELD.label = 3
GETPVPCONTI_EQUIP_FIELD.has_default_value = false
GETPVPCONTI_EQUIP_FIELD.default_value = {}
GETPVPCONTI_EQUIP_FIELD.message_type = role_pb.EQUIP
GETPVPCONTI_EQUIP_FIELD.type = 11
GETPVPCONTI_EQUIP_FIELD.cpp_type = 10

GETPVPCONTI_CURRENCY_FIELD.name = "currency"
GETPVPCONTI_CURRENCY_FIELD.full_name = ".GetPvpConti.currency"
GETPVPCONTI_CURRENCY_FIELD.number = 4
GETPVPCONTI_CURRENCY_FIELD.index = 3
GETPVPCONTI_CURRENCY_FIELD.label = 2
GETPVPCONTI_CURRENCY_FIELD.has_default_value = false
GETPVPCONTI_CURRENCY_FIELD.default_value = nil
GETPVPCONTI_CURRENCY_FIELD.message_type = role_pb.CURRENCY
GETPVPCONTI_CURRENCY_FIELD.type = 11
GETPVPCONTI_CURRENCY_FIELD.cpp_type = 10

GETPVPCONTI_ITEM_FIELD.name = "item"
GETPVPCONTI_ITEM_FIELD.full_name = ".GetPvpConti.item"
GETPVPCONTI_ITEM_FIELD.number = 5
GETPVPCONTI_ITEM_FIELD.index = 4
GETPVPCONTI_ITEM_FIELD.label = 3
GETPVPCONTI_ITEM_FIELD.has_default_value = false
GETPVPCONTI_ITEM_FIELD.default_value = {}
GETPVPCONTI_ITEM_FIELD.message_type = role_pb.ITEM
GETPVPCONTI_ITEM_FIELD.type = 11
GETPVPCONTI_ITEM_FIELD.cpp_type = 10

GETPVPCONTI.name = "GetPvpConti"
GETPVPCONTI.full_name = ".GetPvpConti"
GETPVPCONTI.nested_types = {}
GETPVPCONTI.enum_types = {}
GETPVPCONTI.fields = {GETPVPCONTI_BATTLE_FIELD, GETPVPCONTI_CARD_FIELD, GETPVPCONTI_EQUIP_FIELD, GETPVPCONTI_CURRENCY_FIELD, GETPVPCONTI_ITEM_FIELD}
GETPVPCONTI.is_extendable = false
GETPVPCONTI.extensions = {}
GETPVPTOTAL_BATTLE_FIELD.name = "battle"
GETPVPTOTAL_BATTLE_FIELD.full_name = ".GetPvpTotal.battle"
GETPVPTOTAL_BATTLE_FIELD.number = 1
GETPVPTOTAL_BATTLE_FIELD.index = 0
GETPVPTOTAL_BATTLE_FIELD.label = 2
GETPVPTOTAL_BATTLE_FIELD.has_default_value = false
GETPVPTOTAL_BATTLE_FIELD.default_value = nil
GETPVPTOTAL_BATTLE_FIELD.message_type = role_pb.BATTLE
GETPVPTOTAL_BATTLE_FIELD.type = 11
GETPVPTOTAL_BATTLE_FIELD.cpp_type = 10

GETPVPTOTAL_CARD_FIELD.name = "card"
GETPVPTOTAL_CARD_FIELD.full_name = ".GetPvpTotal.card"
GETPVPTOTAL_CARD_FIELD.number = 2
GETPVPTOTAL_CARD_FIELD.index = 1
GETPVPTOTAL_CARD_FIELD.label = 3
GETPVPTOTAL_CARD_FIELD.has_default_value = false
GETPVPTOTAL_CARD_FIELD.default_value = {}
GETPVPTOTAL_CARD_FIELD.message_type = role_pb.CARD
GETPVPTOTAL_CARD_FIELD.type = 11
GETPVPTOTAL_CARD_FIELD.cpp_type = 10

GETPVPTOTAL_EQUIP_FIELD.name = "equip"
GETPVPTOTAL_EQUIP_FIELD.full_name = ".GetPvpTotal.equip"
GETPVPTOTAL_EQUIP_FIELD.number = 3
GETPVPTOTAL_EQUIP_FIELD.index = 2
GETPVPTOTAL_EQUIP_FIELD.label = 3
GETPVPTOTAL_EQUIP_FIELD.has_default_value = false
GETPVPTOTAL_EQUIP_FIELD.default_value = {}
GETPVPTOTAL_EQUIP_FIELD.message_type = role_pb.EQUIP
GETPVPTOTAL_EQUIP_FIELD.type = 11
GETPVPTOTAL_EQUIP_FIELD.cpp_type = 10

GETPVPTOTAL_CURRENCY_FIELD.name = "currency"
GETPVPTOTAL_CURRENCY_FIELD.full_name = ".GetPvpTotal.currency"
GETPVPTOTAL_CURRENCY_FIELD.number = 4
GETPVPTOTAL_CURRENCY_FIELD.index = 3
GETPVPTOTAL_CURRENCY_FIELD.label = 2
GETPVPTOTAL_CURRENCY_FIELD.has_default_value = false
GETPVPTOTAL_CURRENCY_FIELD.default_value = nil
GETPVPTOTAL_CURRENCY_FIELD.message_type = role_pb.CURRENCY
GETPVPTOTAL_CURRENCY_FIELD.type = 11
GETPVPTOTAL_CURRENCY_FIELD.cpp_type = 10

GETPVPTOTAL_ITEM_FIELD.name = "item"
GETPVPTOTAL_ITEM_FIELD.full_name = ".GetPvpTotal.item"
GETPVPTOTAL_ITEM_FIELD.number = 5
GETPVPTOTAL_ITEM_FIELD.index = 4
GETPVPTOTAL_ITEM_FIELD.label = 3
GETPVPTOTAL_ITEM_FIELD.has_default_value = false
GETPVPTOTAL_ITEM_FIELD.default_value = {}
GETPVPTOTAL_ITEM_FIELD.message_type = role_pb.ITEM
GETPVPTOTAL_ITEM_FIELD.type = 11
GETPVPTOTAL_ITEM_FIELD.cpp_type = 10

GETPVPTOTAL.name = "GetPvpTotal"
GETPVPTOTAL.full_name = ".GetPvpTotal"
GETPVPTOTAL.nested_types = {}
GETPVPTOTAL.enum_types = {}
GETPVPTOTAL.fields = {GETPVPTOTAL_BATTLE_FIELD, GETPVPTOTAL_CARD_FIELD, GETPVPTOTAL_EQUIP_FIELD, GETPVPTOTAL_CURRENCY_FIELD, GETPVPTOTAL_ITEM_FIELD}
GETPVPTOTAL.is_extendable = false
GETPVPTOTAL.extensions = {}
EXITPVP_BATTLE_FIELD.name = "battle"
EXITPVP_BATTLE_FIELD.full_name = ".ExitPvp.battle"
EXITPVP_BATTLE_FIELD.number = 1
EXITPVP_BATTLE_FIELD.index = 0
EXITPVP_BATTLE_FIELD.label = 2
EXITPVP_BATTLE_FIELD.has_default_value = false
EXITPVP_BATTLE_FIELD.default_value = nil
EXITPVP_BATTLE_FIELD.message_type = role_pb.BATTLE
EXITPVP_BATTLE_FIELD.type = 11
EXITPVP_BATTLE_FIELD.cpp_type = 10

EXITPVP.name = "ExitPvp"
EXITPVP.full_name = ".ExitPvp"
EXITPVP.nested_types = {}
EXITPVP.enum_types = {}
EXITPVP.fields = {EXITPVP_BATTLE_FIELD}
...
GetPvpConti = protobuf.Message(GETPVPCONTI)
GetPvpTotal = protobuf.Message(GETPVPTOTAL)
