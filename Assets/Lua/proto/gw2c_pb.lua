...
local BUYAVOIDTIME_PVP_FIELD = protobuf.FieldDescriptor();
...
BUYAVOIDTIME_PVP_FIELD.name = "pvp"
BUYAVOIDTIME_PVP_FIELD.full_name = ".BuyAvoidTime.pvp"
BUYAVOIDTIME_PVP_FIELD.number = 3
BUYAVOIDTIME_PVP_FIELD.index = 2
BUYAVOIDTIME_PVP_FIELD.label = 2
BUYAVOIDTIME_PVP_FIELD.has_default_value = false
BUYAVOIDTIME_PVP_FIELD.default_value = nil
BUYAVOIDTIME_PVP_FIELD.message_type = role_pb.PVP
BUYAVOIDTIME_PVP_FIELD.type = 11
BUYAVOIDTIME_PVP_FIELD.cpp_type = 10

BUYAVOIDTIME.name = "BuyAvoidTime"
BUYAVOIDTIME.full_name = ".BuyAvoidTime"
BUYAVOIDTIME.nested_types = {}
BUYAVOIDTIME.enum_types = {}
BUYAVOIDTIME.fields = {BUYAVOIDTIME_ITEM_FIELD, BUYAVOIDTIME_CURRENCY_FIELD, BUYAVOIDTIME_PVP_FIELD}
