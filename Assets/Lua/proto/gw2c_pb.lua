...
local CARDTAKEMEDAL_CURRENCY_FIELD = protobuf.FieldDescriptor();
...
CARDTAKEMEDAL_CURRENCY_FIELD.name = "currency"
CARDTAKEMEDAL_CURRENCY_FIELD.full_name = ".CardTakeMedal.currency"
CARDTAKEMEDAL_CURRENCY_FIELD.number = 2
CARDTAKEMEDAL_CURRENCY_FIELD.index = 1
CARDTAKEMEDAL_CURRENCY_FIELD.label = 2
CARDTAKEMEDAL_CURRENCY_FIELD.has_default_value = false
CARDTAKEMEDAL_CURRENCY_FIELD.default_value = nil
CARDTAKEMEDAL_CURRENCY_FIELD.message_type = role_pb.CURRENCY
CARDTAKEMEDAL_CURRENCY_FIELD.type = 11
CARDTAKEMEDAL_CURRENCY_FIELD.cpp_type = 10

CARDTAKEMEDAL.name = "CardTakeMedal"
CARDTAKEMEDAL.full_name = ".CardTakeMedal"
CARDTAKEMEDAL.nested_types = {}
CARDTAKEMEDAL.enum_types = {}
CARDTAKEMEDAL.fields = {CARDTAKEMEDAL_CARD_FIELD, CARDTAKEMEDAL_CURRENCY_FIELD}
